...
//     const cartWrapper = document.querySelector('.food-card');
...
function calcCartPrice() {
    const cartItems = document.querySelectorAll('.food-card__box');
    ...
    cartItems.forEach(function (item) {
        ...
        const priceEl = item.querySelector('.food-card__price-money');
...
window.addEventListener('click', function(event) {
    ...
    if(event.target.hasAttribute('data-action') && event.target.closest('.food-card')) {
        calcCartPrice();
    }
